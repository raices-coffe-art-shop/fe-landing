...
import { getMenuItems } from "@/sanity/lib/menu";
...
//   /carta/imprimir → herramienta interna, con fotos y botones de descarga.
//   /carta    → lo que ve quien escanea el QR en la mesa: solo la carta.
