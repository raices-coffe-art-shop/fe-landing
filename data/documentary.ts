...
export const archiveCategories = [
  ...
  { id: "cafe", title: "Café", status: "in-editing" as ContentStatus, summary: "Fotografías, entrevistas y notas de proceso por incorporar.", media: [] },
  { id: "miel", title: "Miel", status: "pending" as ContentStatus, summary: "Material documental pendiente de registro y autorización.", media: [] },
  { id: "cacao", title: "Cacao", status: "pending" as ContentStatus, summary: "Categoría preparada para futuras entrevistas.", media: [] },
  { id: "alimentos", title: "Quesos y alimentos", status: "pending" as ContentStatus, summary: "Espacio para alimentos tradicionales, pan, palta y quesos.", media: [] },
  { id: "arte", title: "Arte y oficios", status: "in-editing" as ContentStatus, summary: "Autoría, técnica y procedencia por documentar con cada pieza.", media: [] },
];
