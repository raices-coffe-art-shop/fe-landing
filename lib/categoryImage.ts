import type { CatalogImage, CatalogItem } from "@/sanity/lib/catalogTypes";
...
// Las fotos de producto llegan a tamaño de ficha (1200x1400) y en la carta se
// imprimen a 58 mm, así que se pide al CDN una versión proporcionada: un PDF de
// carta liviano se comparte por WhatsApp sin problemas. Si la URL no admite
// parámetros (imagen local), se deja igual.
