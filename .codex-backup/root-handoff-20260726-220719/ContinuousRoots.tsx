  ...
  useEffect(() => {
    ...
    const measure = () => {
      ...
      const continuationAnchors: Point[] = [
        ...
        { x: width * continuationX, y: territory.top + 12 },
      ...
      addBranch(continuationAnchors[1], compact ? 0.75 : 0.8, compact ? 132 : 194, 2.15, 0.5, "continuation");
      addBranch(continuationAnchors[2], compact ? 0.79 : 0.84, compact ? 90 : 138, 1.7, 0.44, "continuation");
      addBranch(continuationAnchors[3], compact ? 0.77 : 0.83, compact ? 138 : 206, 1.82, 0.42, "continuation");
      addBranch(continuationAnchors[4], compact ? 0.8 : 0.85, compact ? 102 : 152, 1.7, 0.38, "continuation");
      addBranch(continuationAnchors[5], compact ? 0.79 : 0.85, compact ? 132 : 194, 1.62, 0.36, "continuation");
      if (journey) {
